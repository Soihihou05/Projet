...
<head>
    ...
    <style>
        @keyframes typing {
            ...
            40% {
                width: 100%;
                /* Le texte est complètement écrit à 40% de l'animation */
            }
...
<body class="bg-[#f9fafb] min-h-screen flex flex-col">
    ...
    <main class="flex-grow">
        <section class="text-center mt-10 px-6">
            <h1 class="text-5xl font-bold text-gray-800 mb-4">Bienvenue sur <span class="text-red-600">TaskMaster</span>
            </h1>
            <p class="text-lg text-gray-600 mb-8">Votre allié pour organiser vos tâches, booster votre productivité et
                atteindre vos objectifs sereinement.</p>
        ...
        <section class="mt-12 px-6">
            {{-- <img src="https://www.nme.com/wp-content/uploads/2021/05/Taskmaster_Logo.jpg"
             alt="Productivity Illustration"
             class="w-full max-w-4xl mx-auto rounded-lg shadow-md object-cover"> --}}
            <video class="mx-auto block w-full max-w-[60%] rounded-lg shadow-md" autoplay controls>
        ...
        <section class="mt-16 px-6 max-w-7xl mx-auto">
            <h2 class="text-3xl font-bold text-center text-gray-800 mb-10">Pourquoi choisir TaskMaster ?</h2>

            <div class="grid md:grid-cols-3 gap-8 text-center">
                <div class="bg-white p-6 rounded-lg shadow hover:shadow-lg transition">
                    <img src="https://cdn-icons-png.flaticon.com/512/3595/3595455.png" alt="Planifier"
                        class="h-20 mx-auto mb-4">
                    <h3 class="text-xl font-semibold text-gray-800 mb-2">Planifiez Facilement</h3>
                    <p class="text-gray-600">Créez, organisez et visualisez vos tâches en quelques clics.</p>
                </div>

                <div class="bg-white p-6 rounded-lg shadow hover:shadow-lg transition">
                    <img src="https://cdn-icons-png.flaticon.com/512/446/446353.png" alt="Prioriser"
                        class="h-20 mx-auto mb-4">
                    <h3 class="text-xl font-semibold text-gray-800 mb-2">Priorisez Intelligemment</h3>
                    <p class="text-gray-600">Définissez vos priorités pour ne jamais perdre le cap.</p>
                </div>

                <div class="bg-white p-6 rounded-lg shadow hover:shadow-lg transition">
                    <img src="https://cdn-icons-png.flaticon.com/512/190/190411.png" alt="Réussir"
                        class="h-20 mx-auto mb-4">
                    <h3 class="text-xl font-semibold text-gray-800 mb-2">Réussissez Rapidement</h3>
                    <p class="text-gray-600">Cochez vos tâches et sentez votre progression jour après jour.</p>
                </div>
            </div>
        </section>
        <!-- About Section -->
        <section class="mt-20 px-6 max-w-7xl mx-auto">
            <div class="bg-white p-8 rounded-lg shadow-lg text-center">
                <h2 class="text-3xl font-bold text-gray-800 mb-6">À propos de TaskMaster</h2>
                <p class="text-gray-600 text-lg">
                    TaskMaster est né d'une idée simple : vous aider à mieux organiser votre vie quotidienne.
                    Nous croyons que chaque tâche accomplie vous rapproche de vos rêves.
                    Gérez votre temps, vos projets, et vos objectifs avec simplicité et élégance.
                </p>
            </div>
        </section>
        ...
        <section class="mt-20 px-6 max-w-7xl mx-auto">
            <h2 class="text-3xl font-bold text-center text-gray-800 mb-10">Ils nous font confiance</h2>

            <div class="grid md:grid-cols-3 gap-8">
                <div class="bg-gray-50 p-6 rounded-lg shadow hover:shadow-lg transition text-center">
                    <img src="https://randomuser.me/api/portraits/women/44.jpg" alt="User 1"
                        class="w-20 h-20 rounded-full mx-auto mb-4">
                    <p class="italic text-gray-600">"Depuis que j'utilise TaskMaster, ma productivité a doublé !"</p>
                    <h4 class="font-semibold mt-4 text-gray-800">Sarah M.</h4>
                </div>

                <div class="bg-gray-50 p-6 rounded-lg shadow hover:shadow-lg transition text-center">
                    <img src="https://randomuser.me/api/portraits/men/32.jpg" alt="User 2"
                        class="w-20 h-20 rounded-full mx-auto mb-4">
                    <p class="italic text-gray-600">"Simple, rapide, et efficace. Je recommande à 100%."</p>
                    <h4 class="font-semibold mt-4 text-gray-800">Ali B.</h4>
                </div>

                <div class="bg-gray-50 p-6 rounded-lg shadow hover:shadow-lg transition text-center">
                    <img src="https://randomuser.me/api/portraits/men/76.jpg" alt="User 3"
                        class="w-20 h-20 rounded-full mx-auto mb-4">
                    <p class="italic text-gray-600">"Un design magnifique et une interface ultra intuitive."</p>
                    <h4 class="font-semibold mt-4 text-gray-800">Mohamed K.</h4>
                </div>
            </div>
        </section>
        <section class="py-16 bg-white">
            <div class="max-w-7xl mx-auto text-center">
                <h2 class="text-3xl font-bold text-gray-800 mb-6">Notre communauté en chiffres</h2>
                <div class="text-5xl font-extrabold text-red-600">24</div>
                <p class="text-gray-600 mt-4">Utilisateurs inscrit ! ❤️</p>
            </div>
        </section>

        <!-- Final Call To Action -->
        <section class="mt-20 px-6 max-w-7xl mx-auto text-center">
            <div class="bg-red-600 text-white py-12 rounded-lg shadow-lg">
                <h2 class="text-3xl font-bold mb-6">Prêt à devenir maître de votre temps ?</h2>
                <p class="text-lg mb-8">Inscrivez-vous gratuitement dès aujourd'hui et commencez votre aventure avec
                    TaskMaster !</p>
                <a href="{{ route('register') }}"
                    class="bg-white text-red-600 font-semibold py-3 px-6 rounded-lg hover:bg-gray-100 transition">
                    S'inscrire
                </a>
            </div>
        </section>
